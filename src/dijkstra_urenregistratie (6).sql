...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 08 jan 2023 om 17:41
...
INSERT INTO `gebruikers` (`id_gebruiker`, `voornaam`, `tussenvoegsel`, `achternaam`, `email`, `wachtwoord`, `usertype`, `secretkey`, `archiveer`) VALUES
(1, 'Dev', 'Elo', 'Per', 'Developer@dev.nl', '$2y$10$AFkUWwv7PfbpbvMQhuan8ek23rdYSb5jqNJSVejSa0R1K4CHTUOVO', 'admin', 'LOF4TVGGlKF7GK3U', 'nee'),
(2, 'Tester', 'de', 'Eric', 'test@test.nl', '$2y$10$oA3p6XFPdRrcI6pfMhpa5uoTKBEz./XgfWW/wiPrkNPbXK.OslgR.', 'medewerker', '36KW2Q5SWEHL4MUW', 'nee'),
(3, 'Petra', 'van der', 'meer', 'petra@dijkstraenvanpuffelen.nl', '$2y$10$ZzMULihCbhlLkzkyW/r0oeGDEFzjxfQTZO7ZZ7Owh3/deluLhlBKe', 'non-actief', 'NIKLMJCGP5HFPRML', 'nee');
...
(1, 2, 'res', '2022-11-16', '2022-12-31', 'nee'),
...
(4, 1, 1, NULL, 'prodemnt', 'nee', 16320, 50220, 64920, '2022-12-15', 'nee'),
(5, 1, 1, NULL, 'prodemnt', 'ja', 16320, 50220, 64920, '2022-12-15', 'nee'),
(6, 1, 1, NULL, 'prodenmstasdad', 'nee', 36000, 45480, 84360, '2022-12-12', 'nee'),
(7, 1, 2, NULL, 'testeranens', 'nee', 14400, 61380, 76080, '2022-12-31', 'nee'),
(8, 1, 2, NULL, 'testeranens', 'nee', 14400, 61380, 76080, '2022-12-31', 'nee'),
(9, 1, 1, 2, 'nunu', 'ja', 4980, 0, 0, '2022-12-25', 'nee'),
(14, 1, 1, NULL, 'ppppppppppppppppppppppppppppp', 'ja', 44580, 0, 0, '2022-12-25', 'nee');
...
--
ALTER TABLE `klanten`
  MODIFY `id_klant` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
